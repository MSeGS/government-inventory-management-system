				...
				{{Form::open(array('url'=>route('indent.store'), 'method'=>'post', 'class'=>'form-vertical'))}}
					...
					<table class="table table-hover">
						...
						<tbody>
							...
							<tr class="{{$item['type'] == 'request'?'warning':''}}">
								<td>
					...
					<div class="row">
						<div class="col-sm-6">
							<!-- <p><span class="label label-success">&nbsp;</span> <small><span class="text-muted"><?php echo _('Indents');?></span></small></p> -->
							<p><span class="label label-warning">&nbsp;</span> <small><span class="text-muted"><?php echo _('Requirements');?></span></small></p>
						</div>
						<div class="col-sm-1 text-right"><span class="hidden saving-chit-form text-success"><i class="fa fa-spinner fa-spin"></i></span></div>
