...
<div class="col-md-12">
	<div class="row">
		...
		<div class="col-md-12">
			<div class="row">
				{{Form::open(array('url'=>route('damage.trash'),'method'=>'get','class'=>'form-vertical'))}}
					<div class="col-md-2">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="{{route('damage.restore', $damage->id)}}" class="btn btn-xs btn-success tooltip-top" title="<?php echo _('Restore Damage') ?>"><i class="fa fa-chevron-circle-left"></i></a>
