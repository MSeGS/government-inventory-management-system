...
Route::post('login', array('before'=>'sentry', 'uses'=>'AuthController@authenticate', 'as'=>'login.submit'));
...
Route::put('group/{id}/permission', array('uses'=>'GroupController@updatePermission', 'as'=>'group.updatePermission'));
