...
Route::get('report/product-detail/{id}', array('before'=>'sentry', 'uses'=>'ReportController@productDetail', 'as'=>'report.product-detail'));
Route::get('report/product-indent/{date?}', array('before'=>'sentry', 'uses'=>'ReportController@productIndent', 'as'=>'report.product-indent'));
